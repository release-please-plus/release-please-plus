...
describe('LinkedVersions plugin', () => {
  ...
  it('should sync versions pull requests', async () => {
    ...
    expect(packageData3).toBeDefined();
    expect(packageData2?.version).toEqual(packageData3?.version);
  ...
  it('should allow multiple groups of linked versions', async () => {
    ...
    expect(groupPullRequest1.headRefName).not.toEqual(
      groupPullRequest2.headRefName
    );
    expect(groupPullRequest1.headRefName).toEqual(
      expect.not.arrayContaining([' '])
    );
    expect(groupPullRequest2.headRefName).toEqual(
      expect.not.arrayContaining([' '])
    );
  });
});
