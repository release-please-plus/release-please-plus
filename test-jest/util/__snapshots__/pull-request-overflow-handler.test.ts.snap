...
exports[`FilePullRequestOverflowHandler handleOverflow writes large pull request body contents to a file 1`] = `"This release is too large to preview in the pull request body. View the full release notes here: https://github.com/test-owner/test-repo/blob/my-head-branch--release-notes/release-notes.md"`;
